...
public final class NavigableImagePanel extends JPanel implements NavigableImagePanelInterface {

    /**
     * <p>
     * Identifies a change to the zoom level.</p>
     */
    public static String ZOOM_LEVEL_CHANGED_PROPERTY = "zoomLevel";
    /**
     * <p>
     * Identifies a change to the zoom increment.</p>
     */
    public static String ZOOM_INCREMENT_CHANGED_PROPERTY = "zoomIncrement";
    /**
     * <p>Identifies that the image in the panel has changed.</p>
     */
    public static String IMAGE_CHANGED_PROPERTY = "image";
    private static double SCREEN_NAV_IMAGE_FACTOR = 0.15; // 15% of panel's width
    private static double NAV_IMAGE_FACTOR = 0.3; // 30% of panel's width
    private static double HIGH_QUALITY_RENDERING_SCALE_THRESHOLD = 1.0;
    private static Object INTERPOLATION_TYPE = RenderingHints.VALUE_INTERPOLATION_BILINEAR;
    ...
    public String getImageName() {
        return image.getProperty("name").toString();
    }
    ...
    //Paints a orange outline over the navigation image indicating
